defmodule MyLibWeb.CredentialAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_my_lib_web_credential_remember_me"
  ...
  the current_credential:
      ...
      defmodule MyLibWeb.PageLive do
        ...
        on_mount {MyLibWeb.CredentialAuth, :mount_current_credential}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{MyLibWeb.CredentialAuth, :ensure_authenticated}] do
